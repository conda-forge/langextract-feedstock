...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langextract-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langextract-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langextract
# for installing globally
pixi global install langextract
```
...
It is possible to list all of the versions of `langextract` available on your platform:
...
```
pixi search langextract --channel conda-forge
```
